---
Project: AI Job Agent Platform
Stack: FastAPI (Python 3.11+), Next.js (TypeScript), PostgreSQL + pgvector, Redis, ARQ, SQLAlchemy, Alembic, Pydantic, Tailwind CSS, Docker
---
